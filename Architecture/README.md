...
| 섹션 | 내용 | 상태 | 근거 |
|---|---|---|---|
| [읽는-순서](#읽는-순서) | 처음 읽을 때의 순서 | proposed | 체크리스트 C1 |
| [문서-목록](#문서-목록) | 문서마다 답하는 질문과 주요 섹션 | proposed | 체크리스트 C1 |
| [관련-문서](#관련-문서) | 다른 폴더 안내 | — | — |

> [!NOTE]
> 제안 — 이 안내 문서의 모든 섹션은 초안이며 승인 체크리스트 C1 결정 대기입니다. 각 문서 안의 규칙에는 adopted와 proposed가 섞여 있습니다.
...
- [JM_Protocol 안내](../README.md) — 전체 문서 지도와 독자별 경로
