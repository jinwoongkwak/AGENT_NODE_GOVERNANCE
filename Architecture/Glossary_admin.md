...
| Coordinator | 작업 계약 고정, 호출 순서, 상태, 저장, HQ 인계를 맡는 역할 | [역할-요약](../AI/Roles/Coordinator_agent.md#역할-요약) | 확장 사양 |
| Planner | 완료 기준을 만족하는 실행 가능한 계획을 쓰는 역할 | [역할-요약](../AI/Roles/Planner_agent.md#역할-요약) | 확장 사양 |
| Evaluator | 계획을 평가하고 실행 결과를 검증하는 역할 | [역할-요약](../AI/Roles/Evaluator_agent.md#역할-요약) | 확장 사양 |
| Executor | 통과·승인된 계획을 실행하고 증거를 모으는 역할 | [역할-요약](../AI/Roles/Executor_agent.md#역할-요약) | 확장 사양 |
...
| 작업 계약 | 목표·산출물·입력·범위·완료 기준·위임 권한·예산·보고 시점을 고정한 지시 | [계약-정규화](../AI/Roles/Coordinator_agent.md#계약-정규화) | 확장 사양 |
...
| run | 한 계약 버전으로 진행하는 교환 기록 묶음 | [id와-파일명](../AI/Task_and_Record_Schema_agent.md#id와-파일명) | 확장 사양 |
| 필수 조건 | 하나라도 실패하면 계획을 실행하지 않는 조건 G1–G6 | [필수-조건](../AI/Roles/Evaluator_agent.md#필수-조건) | 확장 사양 |
| 판정 | 평가·검증 결과 값 (`verdict`) | [판정](../AI/Roles/Evaluator_agent.md#판정) | 확장 사양 |
| 발견 | Evaluator가 기록한 결함 (finding) | [발견-기록](../AI/Roles/Evaluator_agent.md#발견-기록) | 확장 사양 |
| checkpoint | 중단·대기 전에 저장하는 재개 정보 | [checkpoint와-재개](../AI/Roles/Coordinator_agent.md#checkpoint와-재개) | 확장 사양 |
| receipt | 실행 단계가 끝났다는 기록 | [receipt와-재시도](../AI/Roles/Executor_agent.md#receipt와-재시도) | 확장 사양 |
...
| 스키마 | 문서 종류·필드·본문 구획·문서 사이 규칙의 약속 | [스키마란](../AI/Task_and_Record_Schema_agent.md#스키마란) | 확장 사양 |
| 불변식 | 문서 사이에 항상 성립해야 하는 규칙 | [불변식](../AI/Task_and_Record_Schema_agent.md#불변식) | 확장 사양 |
...
| 휴지통 | 삭제 대신 파일을 옮기는 곳 ([`{trash}`](AGENT_NODE_GOVERNANCE/Architecture/Company_Profile_admin.md#작업-공간-경로)) | [파일-작업](../AI/Common_Rules_agent.md#파일-작업) | 운영 |
| 백업 | 수정 전에 만드는 복구 지점. git commit 또는 zip | [백업](../AI/Common_Rules_agent.md#백업) | 운영 |
| 중첩 저장소 | 작업 공간 안에 있는 git 저장소 (submodule) | [중첩-저장소](../AI/Common_Rules_agent.md#중첩-저장소) | 운영 |
| Router | TaskNote와 교환 기록 파일을 만들고 제자리에 두는 명령줄 프로그램 | [router의-역할](../AI/Routing_agent.md#router의-역할) | 확장 사양 |
| 스테이징 | 역할이 본문을 먼저 써 두는 동기화 밖 임시 위치 | [런타임과-router](Workspace_and_Tools_admin.md#런타임과-router) | 확장 사양 |
| 잠금 | 같은 작업·경로를 두 세션이 동시에 쓰지 못하게 하는 표시 | [잠금과-예산](../AI/Roles/Coordinator_agent.md#잠금과-예산) | 확장 사양 |
