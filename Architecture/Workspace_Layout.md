...
| 섹션 | 내용 | 상태 | 근거 |
|---|---|---|---|
| [최소-구조](#최소-구조) | 새 회사의 기본 폴더 | proposed | 검토 C1·C9 |
| [프로젝트-수명](#프로젝트-수명) | 시작·실행·종료와 정본 | proposed | 검토 C9 |
| [배치-판단](#배치-판단) | 중복 없이 자료를 두는 기준 | proposed | 검토 C9 |
| [관련-문서](#관련-문서) | 도입과 문서 규칙 | — | — |
...
workspace/
  ...
  00_HQ/
    ...
    10_PLANNING/Tasks/        # 지시·승인·실행·보고
    90_SYSTEM/
      JM_Protocol/            # 상위 프로토콜 저장소
...
- [문서 체계](Document_System.md) — 정본의 역할
- [설치와 도입](../Setup/README.md) — 새 회사 시작
- [이전 절차](../Setup/Migration.md) — 기존 폴더의 실제 변경
