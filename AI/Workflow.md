...
| 섹션 | 내용 | 상태 | 근거 |
|---|---|---|---|
| [루프-한눈에](#루프-한눈에) | 현행 8단계 루프와 제안된 역할 루프 | adopted, proposed | 기존 AI_Protocol §6, 제안서 01 |
| [접수](#접수) | 요청을 받아 작업을 준비 | adopted, proposed | DEC-HQ-005, 제안서 01 |
| [계획과-평가](#계획과-평가) | 계획 작성, 독립 평가, 수정 반복 | proposed | 제안서 01·04 |
| [권한-검사](#권한-검사) | 실행 전에 확인할 권한과 입력 | adopted, proposed | 기존 AI_Protocol §5·§6, 제안서 05 |
| [실행](#실행) | 승인된 범위의 실행 | adopted, proposed | 기존 AI_Protocol §6, 제안서 05 |
| [결과-검증](#결과-검증) | 실제 결과와 완료 기준 대조 | proposed | 제안서 04 |
| [보고와-종료](#보고와-종료) | 기록, 정본 반영, 후속 제안, 종료 | adopted, proposed | DEC-HQ-005, 제안서 05 |
| [hq-판단과-재개](#hq-판단과-재개) | HQ 결정 대기와 재개 | adopted, proposed | 기존 Handoff §2, 제안서 05 |
| [검토-깊이별-경로](#검토-깊이별-경로) | 경량·표준·엄격에서 생략되는 단계 | proposed | 제안서 04 |
| [단계별-기록](#단계별-기록) | 단계마다 남는 기록과 다음 주체 | proposed | 제안서 01·02 |
| [관련-문서](#관련-문서) | 역할 문서 | — | — |
...
기록 종류의 필수 구획은 [교환 기록 종류](Task_and_Record_Schema.md#교환-기록-종류-제안)에 있습니다.
